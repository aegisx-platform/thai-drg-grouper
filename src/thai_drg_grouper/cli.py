...
def main():
    parser = argparse.ArgumentParser(
        prog='thai-drg-grouper',
        description='Thai DRG Grouper - Multi-Version Support'
    )
    ...
    if args.command == 'list':
        ...
        result = manager.group(
            version, pdx=args.pdx, sdx=sdx, procedures=procedures,
            age=args.age, sex=args.sex, los=args.los
        )
