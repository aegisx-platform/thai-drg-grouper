...
from thai_drg_grouper import ThaiDRGGrouper, ThaiDRGGrouperManager, GrouperResult
...
class TestGrouper:
    ...
    def test_group_pneumonia(self, grouper):
        ...
        assert result.is_surgical == False
...
class TestTypes:
    ...
    def test_grouper_result_to_dict(self):
        ...
        result = GrouperResult(
            version='6.3', pdx='J189', sdx=[], procedures=[],
            age=30, sex='M', los=5, mdc='04', mdc_name='Test',
            dc='0450', drg='04509', drg_name='Test DRG',
            rw=1.0, rw0d=0.5, adjrw=1.0, wtlos=5.0, ot=10,
            pcl=0, cc_list=[], mcc_list=[], has_or_procedure=False,
            is_surgical=False, los_status='normal', is_valid=True,
            errors=[], warnings=[]
        )
