...
**การตั้งค่า CORS:** สามารถกำหนด origins ที่อนุญาตผ่าน environment variable:
```bash
# สร้างไฟล์ .env
...
thai-drg-grouper serve --port 8000
```
ดูรายละเอียดเพิ่มเติมที่ [การติดตั้ง - การตั้งค่า](getting-started/installation.md#การตั้งค่า-configuration)
